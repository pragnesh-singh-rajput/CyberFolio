...
export default function ContactSection() {
  ...
  return (
    ...
    >
      ...
      <div ref={circle1Ref} className="absolute -z-10 top-[5%] right-[-10%] w-[25rem] h-[25rem] md:w-[35rem] md:h-[35rem] bg-primary/25 rounded-full filter blur-[120px] md:blur-[180px] opacity-40"></div>
      <div ref={circle2Ref} className="absolute -z-10 bottom-[10%] left-[-15%] w-[30rem] h-[30rem] md:w-[40rem] md:h-[40rem] bg-accent/30 rounded-full filter blur-[100px] md:blur-[160px] opacity-50"></div>

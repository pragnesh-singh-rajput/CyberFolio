  ...
  return (
    <div className="flex flex-col min-h-screen bg-background text-foreground">
      ...
      <main className="flex-grow">
        {/* HeroSection has internal animations and is not wrapped for immediate visibility */}
        <HeroSection /> 
        
        <div className="container mx-auto px-4 md:px-6 lg:px-8 space-y-12 md:space-y-16 lg:space-y-20">
          <AnimatedSection id="about" className="pt-16 md:pt-24 text-center" delay="delay-200">
